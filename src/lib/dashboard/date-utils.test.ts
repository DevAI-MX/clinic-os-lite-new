...
describe("mondayIndex", () => {
  // mondayIndex usa getDay() LOCAL; un ISO date-only ("2026-05-18") se
  // parsea como medianoche UTC, que al oeste de UTC cae el día anterior
  // — el constructor (y,m,d) crea la fecha en hora local y hace el test
  // independiente de la zona de la máquina.
